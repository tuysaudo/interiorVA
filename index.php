				...
				<div class="portfolio-wrapper">
					<div class="portfolio-option-wrapper portfolio-option-wrapper-first ">
					   <div class="portfolio-option portfolio-option-first">
						  <h1 class="title-small"><a href="http://localhost/html/interior/category/">Private <br />
							 Homes</a>
						  </h1>
						  <p>We work on the most exceptional homes worldwide using cutting edge materials and surfaces.</p>
						  <p class="mobile-only">
							 <a class="back icon icon-inline icon-cross" href="http://localhost/html/interior/">Back</a>
						  </p>
					   ...
					   <div class="portfolio-background-container portfolio-background-first">
						  <div class="portfolio-background fullscreen-weak preload" data-centre="50,20" data-centre-element="div" style="background-image:url('http://localhost/html/interior/assets/images/fullscreen/800/picasso-portfolio.jpg')"></div>
					...
					<div class="portfolio-option-wrapper portfolio-option-wrapper-second ">
					   <div class="portfolio-option portfolio-option-second">
						  <h1 class="title-small"><a href="http://localhost/html/interior/category/">Luxury<br />
							 Developments</a>
						  </h1>
					   ...
					   <div class="portfolio-background-container portfolio-background-second">
						  <div class="portfolio-background fullscreen-weak preload" data-centre="50,25" data-centre-element="div" style="background-image:url('http://localhost/html/interior/assets/images/fullscreen/800/chelseath-fullscreen-1.jpg')"></div>
					...
					<div class="portfolio-option-wrapper portfolio-option-wrapper-four ">
					   <div class="portfolio-option portfolio-option-four portfolio-option-nolink">
						  ...
						  <div class="portfolio-icon-wrapper is-link">
							 <a href="http://localhost/html/interior/" target="_blank">VISIT THE LANSERRING WEBSITE</a><!--<span class="portfolio-icon"></span>-->
						  </div>
					   </div>
					   ...
					   <div class="portfolio-background-container portfolio-background-four">
						  <div class="portfolio-background fullscreen-weak preload" data-centre="75,25" data-centre-element="div" style="background-image:url('http://localhost/html/interior/assets/images/fullscreen/800/modern-kitchen-fullscreen-1.jpg')"></div>
